#ifndef STUBBLE_SWITCH_SELECTION_MODE_COMMAND_HPP
#define STUBBLE_SWITCH_SELECTION_MODE_COMMAND_HPP
...
///----------------------------------------------------------------------------------------------------
class SwitchSelectionModeCommand
	: public MPxCommand
{
public:
	///----------------------------------------------------------------------------------------------------
...
#endif // STUBBLE_SWITCH_SELECTION_MODE_COMMAND_HPP